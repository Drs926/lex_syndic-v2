...
| Migration V1 | **MIG-001 et MIG-002 terminés.** `MIG-003` à `MIG-010` non démarrés. |
...
`MIG-002` est vérifié. Toute ouverture de `MIG-003` doit rester séparée et explicite.
